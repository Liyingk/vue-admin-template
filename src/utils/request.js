...
service.interceptors.response.use(
  /**
   * If you want to get http information such as headers or status  如果您想获得http信息，例如头信息或状态信息
  ...
  */
  ...
  response => {
    ...
    // if the custom code is not 20000, it is judged as an error.  这里需要自己修改，和后台的约定
    if (res.code !== 20000) {
      Message({
